...
public class SpendContract {
	...
	public static class SpendEntry implements BaseColumns {
		...
		protected static final String SQL_CREATE = "CREATE TABLE " + TABLE_NAME + " (" + _ID
				+ " INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, " + COLUMN_NAME_CATEGORY_ID + " INTEGER, "
				+ COLUMN_NAME_VALUE + " FLOAT, " + COLUMN_NAME_DESCRIPTION + " TEXT, " + COLUMN_NAME_CREATED + " TEXT"
				+ ")";
		protected static final String SQL_DELETE = "DROP TABLE IF EXISTS " + TABLE_NAME;

		protected static final String[] COLUMNS = { _ID, COLUMN_NAME_DESCRIPTION, COLUMN_NAME_CREATED,
				COLUMN_NAME_VALUE, COLUMN_NAME_CATEGORY_ID };
	}
}
